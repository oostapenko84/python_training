...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(First_Name="Olga", Middle_Name="Sergeevna", Last_Name="Ostapenko", Company_Name="Test Company", Address="Test Address", Home_Phone="12345", Mobile_Phone="12345", Work_Phone="12345",Email="test@test.com", Homepage="www.test.com", Birthday="1984", Anniversary="2017", Secondary_Address="Test Address"))
        self.logout(wd)
